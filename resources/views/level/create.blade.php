        ...
        <div class="card-body">
            <form method="POST" action="{{ url('level') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label for="level_kode" class="col-2 control-label col-form-label">Kode Level</label>
                    <div class="col-10">
                ...
                <div class="form-group row">
                    <label for="level_nama" class="col-2 control-label col-form-label">Nama Level</label>
                    <div class="col-10">
